# Form implementation generated from reading ui file 'options_genre_mapper.ui'
#
...
class Ui_GenreMapperOptionsPage(object):
    def setupUi(self, GenreMapperOptionsPage):
        ...
        self.gm_description = QtWidgets.QGroupBox(parent=GenreMapperOptionsPage)
        ...
        self.format_description = QtWidgets.QLabel(parent=self.gm_description)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gm_replacement_pairs = QtWidgets.QGroupBox(parent=GenreMapperOptionsPage)
        ...
        self.cb_use_regex = QtWidgets.QCheckBox(parent=self.gm_replacement_pairs)
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.genre_mapper_first_match_only = QtWidgets.QCheckBox(parent=self.gm_replacement_pairs)
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.genre_mapper_replacement_pairs = QtWidgets.QPlainTextEdit(parent=self.gm_replacement_pairs)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
